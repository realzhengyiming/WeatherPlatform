...
urlpatterns = [  # todo 记得要删除这些坏东西/
    ...
    #      {'post_change_redirect': '/weather_show_app/?success_info=password_change_success',
    #       'template_name': "weather_show_app/password_change_form.html"
    ...
    path("today_temperature_line/", drawviews.today_temperature_detail_line.as_view(), name="today_temperature_line"),  # 这个改成了当踢的天气折线图
